...
function encode(data: GetHeadersPayload): Uint8Array<ArrayBuffer> {
...
function decode(bytes: Uint8Array): [GetHeadersPayload, number] {
...
export const GetHeadersMessage: PeerMessage<GetHeadersPayload> = {
	command: "getheaders",
	codec: { encode, decode },
};
