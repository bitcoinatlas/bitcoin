...
export interface FixedKVStore2Options<K, V> {
	keyCodec: Codec<K>;
	valueCodec: Codec<V>;
...
/**
 * FixedKVStore2 - Disk-first store optimized for fast reads
 * 
 * Design:
 ...
 */
export class FixedKVStore2<K, V> {
	...
	constructor(
		...
		options: FixedKVStore2Options<K, V>,
	) {
