import { FastUint8ArrayMap } from "@project/collections"; // adjust path
...
export class PeerChain implements Iterable<PeerChainNode> {
	...
	public constructor(nodes: Iterable<PeerChainNode> | ArrayIterator<PeerChainNode> = []) {
		this.nodes = Array.from(nodes);
		this.reindex();
	}

	public [Symbol.iterator](): ArrayIterator<PeerChainNode> {
